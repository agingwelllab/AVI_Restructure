...
library(Hmisc)
#Read Data
data=read.csv('AffectValuationIndex_DATA_2021-08-11_1336.csv')
#Setting Labels
...
label(data$a_strong_hp)="strong"
label(data$a_sluggish_ln)="sluggish"
label(data$a_euphoric)="euphoric"
label(data$a_idle)="idle"
label(data$a_aroused_h)="aroused"
label(data$a_rested_lp)="rested"
label(data$a_astonished_h)="astonished"
label(data$a_quiet_l)="quiet"
label(data$a_surprised_h)="surprised"
label(data$a_still_l)="still"
label(data$a_passive_l)="passive"
label(data$a_inactive)="inactive"
...
label(data$i_strong_hp)="strong"
label(data$i_sluggish_ln)="sluggish"
label(data$i_euphoric)="euphoric"
label(data$i_idle)="idle"
label(data$i_aroused_h)="aroused"
label(data$i_rested_lp)="rested"
label(data$i_astonished_h)="astonished"
label(data$i_quiet_l)="quiet"
label(data$i_surprised_h)="surprised"
label(data$i_still_l)="still"
label(data$i_passive_l)="passive"
label(data$i_inactive)="inactive"
...
data$a_strong_hp.factor = factor(data$a_strong_hp,levels=c("1","2","3","4","5"))
data$a_sluggish_ln.factor = factor(data$a_sluggish_ln,levels=c("1","2","3","4","5"))
data$a_euphoric.factor = factor(data$a_euphoric,levels=c("1","2","3","4","5"))
data$a_idle.factor = factor(data$a_idle,levels=c("1","2","3","4","5"))
data$a_aroused_h.factor = factor(data$a_aroused_h,levels=c("1","2","3","4","5"))
data$a_rested_lp.factor = factor(data$a_rested_lp,levels=c("1","2","3","4","5"))
data$a_astonished_h.factor = factor(data$a_astonished_h,levels=c("1","2","3","4","5"))
data$a_quiet_l.factor = factor(data$a_quiet_l,levels=c("1","2","3","4","5"))
data$a_surprised_h.factor = factor(data$a_surprised_h,levels=c("1","2","3","4","5"))
data$a_still_l.factor = factor(data$a_still_l,levels=c("1","2","3","4","5"))
data$a_passive_l.factor = factor(data$a_passive_l,levels=c("1","2","3","4","5"))
data$a_inactive.factor = factor(data$a_inactive,levels=c("1","2","3","4","5"))
...
data$a_serene_lp.factor = factor(data$a_serene_lp,levels=c("1","2","3","4","5"))
...
data$i_strong_hp.factor = factor(data$i_strong_hp,levels=c("1","2","3","4","5"))
data$i_sluggish_ln.factor = factor(data$i_sluggish_ln,levels=c("1","2","3","4","5"))
data$i_euphoric.factor = factor(data$i_euphoric,levels=c("1","2","3","4","5"))
data$i_idle.factor = factor(data$i_idle,levels=c("1","2","3","4","5"))
data$i_aroused_h.factor = factor(data$i_aroused_h,levels=c("1","2","3","4","5"))
data$i_rested_lp.factor = factor(data$i_rested_lp,levels=c("1","2","3","4","5"))
data$i_astonished_h.factor = factor(data$i_astonished_h,levels=c("1","2","3","4","5"))
data$i_quiet_l.factor = factor(data$i_quiet_l,levels=c("1","2","3","4","5"))
data$i_surprised_h.factor = factor(data$i_surprised_h,levels=c("1","2","3","4","5"))
data$i_still_l.factor = factor(data$i_still_l,levels=c("1","2","3","4","5"))
data$i_passive_l.factor = factor(data$i_passive_l,levels=c("1","2","3","4","5"))
data$i_inactive.factor = factor(data$i_inactive,levels=c("1","2","3","4","5"))
...
data$i_serene_lp.factor = factor(data$i_serene_lp,levels=c("1","2","3","4","5"))
...
levels(data$a_strong_hp.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$a_sluggish_ln.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$a_euphoric.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$a_idle.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$a_aroused_h.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$a_rested_lp.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$a_astonished_h.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$a_quiet_l.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$a_surprised_h.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$a_still_l.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$a_passive_l.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$a_inactive.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
...
levels(data$a_serene_lp.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
...
levels(data$i_strong_hp.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$i_sluggish_ln.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$i_euphoric.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$i_idle.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$i_aroused_h.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$i_rested_lp.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$i_astonished_h.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$i_quiet_l.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$i_surprised_h.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$i_still_l.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$i_passive_l.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
levels(data$i_inactive.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
...
levels(data$i_serene_lp.factor)=c("Never1","A small amount of the time2","Half the time3","Most of the time4","All the time5")
